...
ActiveRecord::Schema.define(version: 2021_12_14_160101) do
  ...
  create_table "order_statuses", charset: "utf8mb4", force: :cascade do |t|
  ...
  create_table "orders", charset: "utf8mb4", force: :cascade do |t|
    ...
    t.decimal "taxes", precision: 10
    t.string "payment_type"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end

  create_table "purchase_order_statuses", charset: "utf8mb4", force: :cascade do |t|
